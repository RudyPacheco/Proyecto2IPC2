...
@Component({
  selector: 'app-reporte-ganancias-a',
  templateUrl: './reporte-ganancias-a.component.html',
  styleUrls: ['./reporte-ganancias-a.component.css']
})
export class ReporteGananciasAComponent implements OnInit {
  ...
  mostrarReporte(){
   ...
   this.reportComentario=this.reporteAdminService.verReporteGanancia(this.reporteForm.get("revista")?.value,this.fechaI,this.fechaF);
    this.mostrar=true;
  }

  descargarReporte(){
    console.log(this.fechaF + this.fechaI + this.reporteForm.get("revista")?.value);
    const revi =this.reporteAdminService.descargarReporteGanancia(this.reporteForm.get("revista")?.value,this.fechaI,this.fechaF);
