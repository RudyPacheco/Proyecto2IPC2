...
@Component({
  selector: 'app-reporte-comentadas',
  templateUrl: './reporte-comentadas.component.html',
  styleUrls: ['./reporte-comentadas.component.css']
})
export class ReporteComentadasComponent implements OnInit {
  ...
  mostrarReporte(){
   ...
   this.reportComentario=this.reporteAdminService.verReporteRevistaComentada(this.reporteForm.get("revista")?.value,this.fechaI,this.fechaF);
    this.mostrar=true;
  }

  descargarReporte(){
    console.log(this.fechaF + this.fechaI + this.reporteForm.get("revista")?.value);
    const revi =this.reporteAdminService.descargarReporteRevistaComentada(this.reporteForm.get("revista")?.value,this.fechaI,this.fechaF);
