...
@Component({
  selector: 'app-reporte-suscripcion',
  templateUrl: './reporte-suscripcion.component.html',
  styleUrls: ['./reporte-suscripcion.component.css']
})
export class ReporteSuscripcionComponent implements OnInit {
  ...
  mostrarReporte(){
   ...
   this.reportComentario=this.reporteService.veRreporteSuscripciones(this.reporteForm.get("revista")?.value,this.fechaI,this.fechaF);
    this.mostrar=true;
  }

  descargarReporte(){
    console.log(this.fechaF + this.fechaI + this.reporteForm.get("revista")?.value);
    const revi =this.reporteService.descargarRreporteSuscripciones(this.reporteForm.get("revista")?.value,this.fechaI,this.fechaF);
