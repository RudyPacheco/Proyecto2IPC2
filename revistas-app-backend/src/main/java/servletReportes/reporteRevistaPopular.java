 ...
 * @author AndaryuS
 */
@WebServlet(name = "reporteRevistaPopular", urlPatterns = {"/reporteRevistaPopular"})
public class reporteRevistaPopular extends HttpServlet {
  ...
  try {
            ...
            if (revista == null) {
                reporte.reporteRevistasPopulares(fechaI, fechaF, response.getOutputStream());
