 ...
 * @author AndaryuS
 */
@WebServlet(name = "reporteComentadas", urlPatterns = {"/reporteComentadas"})
public class reporteComentadas extends HttpServlet {
...
try {
            ...
            if (revista == null) {
                reporte.reporteRevistasComentadas(fechaI, fechaF, response.getOutputStream());
