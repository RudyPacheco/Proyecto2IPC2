 ...
 * @author AndaryuS
 */
@WebServlet(name = "reporteGananciasAdminServlet", urlPatterns = {"/reporteGananciasAdminServlet"})
public class reporteGananciasAdminServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
           ...
           try {
            ...
            System.out.println(descargar + revista + fechaI + fechaF);
            response.setContentType("application/pdf");
            if (descargar != null) {
                response.setHeader("Content-disposition", "attachment; filename=ReporteComentario.pdf");
            }
            if (revista == null) {
                reporte.reporteGananciasXRevista(fechaI, fechaF, "", response.getOutputStream());
               

            } else {
                reporte.reporteGananciasXRevista(fechaI, fechaF, revista, response.getOutputStream());
