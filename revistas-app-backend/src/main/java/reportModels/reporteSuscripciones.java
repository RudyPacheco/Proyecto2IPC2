...
public class reporteSuscripciones {
    ...
    public reporteSuscripciones(int codigoRevista, String nombreRevista, String usuarioEditor, String nombre_usuario, String fecha_suscripcion, String tipSuscripcion, double ganancia) {
